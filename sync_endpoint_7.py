#!/usr/bin/env python3
"""
Sincronización COMPLETA del endpoint proyectos_cliente
...
from transforms_all_savio import transform_proyectos_cliente

load_dotenv()

def sync_proyectos_cliente():
    """Sincronización completa del endpoint proyectos_cliente."""
    
    print("=" * 80)
    print("🚀 SINCRONIZACIÓN: proyectos_cliente → proyectos_cliente")
    print("=" * 80)
    print()
    ...
    print("📊 Endpoint: https://gsn.maxapex.net/apex/savio/proyectos_cliente/")
    print("💾 Tabla Supabase: proyectos_cliente")
    ...
    try:
        ...
        result = sync_service.sync_data(
            id_field='id',
            transform_fn=transform_proyectos_cliente
        )
