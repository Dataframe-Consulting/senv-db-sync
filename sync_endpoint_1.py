#!/usr/bin/env python3
"""
Sincronización COMPLETA del endpoint v_log_cambios_etapa
...
def sync_v_log_cambios_etapa():
    """Sincronización completa del endpoint prioritario."""
    
    print("=" * 80)
    print("🚀 SINCRONIZACIÓN: v_log_cambios_etapa → log_cambios_etapa")
    print("=" * 80)
    print()
    ...
    print("📊 Endpoint: https://gsn.maxapex.net/ords/savio/v_log_cambios_etapa/")
    print("💾 Tabla Supabase: log_cambios_etapa")
    ...
    try:
        ...
        result = sync_service.sync_data(
            id_field='id',
            transform_fn=transform_log_cambios_etapa
        )
