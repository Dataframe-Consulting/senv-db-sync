"""Component: Obtención de datos para detalle_cotizacion."""
...
ENDPOINT_PATH = 'detalle_cotizacion'
...
def fetch_all(timeout: int = 60, verbose: bool = True) -> Tuple[List[Dict[str, Any]], bool]:
