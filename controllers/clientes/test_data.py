"""
Script de prueba para el controller de Clientes.
...
def test_data_extraction(verbose: bool = True, show_sample: int = 3):
    ...
    try:
        if verbose:
            print("\n" + "="*70)
            print("🧪 TEST DE DATOS: Clientes (SIN SINCRONIZAR)")
            print("="*70)
...
if __name__ == "__main__":
    ...
    if result['success']:
        output_file = f"test_clientes_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
