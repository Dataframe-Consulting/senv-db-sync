#!/usr/bin/env python3
"""
Sincronización COMPLETA del endpoint clientes
...
from transforms_all_savio import transform_clientes
...
def sync_clientes():
    ...
    print("=" * 80)
    print("🚀 SINCRONIZACIÓN: clientes → clientes")
    print("=" * 80)
    print()
    ...
    print("📊 Endpoint: https://gsn.maxapex.net/apex/savio/clientes/")
    print("💾 Tabla Supabase: clientes")
    ...
    try:
        ...
        result = sync_service.sync_data(
            id_field='id',
            transform_fn=transform_clientes
        )
