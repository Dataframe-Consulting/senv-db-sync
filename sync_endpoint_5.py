#!/usr/bin/env python3
"""
Sincronización COMPLETA del endpoint cotizaciones
...
from transforms_all_savio import transform_cotizaciones

load_dotenv()

def sync_cotizaciones():
    """Sincronización completa del endpoint cotizaciones."""
    
    print("=" * 80)
    print("🚀 SINCRONIZACIÓN: cotizaciones → cotizaciones")
    print("=" * 80)
    print()
    ...
    print("📊 Endpoint: https://gsn.maxapex.net/apex/savio/cotizaciones/")
    print("💾 Tabla Supabase: cotizaciones")
    ...
    try:
        ...
        result = sync_service.sync_data(
            id_field='id',
            transform_fn=transform_cotizaciones
        )
